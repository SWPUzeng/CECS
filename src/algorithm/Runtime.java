    ...
    public static void main(String[] args) {
        ...
        for (int l = 0; l < fold; l++) {
            ...
            for (List<double[]> labelData : dataByLabel) {
                ...
                int[][] result = discretization(twoDArray, standardizedData, 0.1);
            ...
            for (double[] rowData : X_test) {
                ...
                rowArray[0] = rowData;
                int[][] result = discretization(rowArray, standardizedData, 0.1);
            ...
            timeList.add(totalTimeSeconds);
            System.out.println("The "+(l+1)+" fold program running time (seconds): " + totalTimeSeconds);

        }
        double averagetime = calculateAverage(timeList);
        double stdDevtime = calculateStandardDeviation(timeList);

        System.out.println("Runtime: " + averagetime + " ±" + stdDevtime);
